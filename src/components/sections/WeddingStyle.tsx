    ...
    renderDescriptionBlock() {
        return (
            <div className="col-md-12 text-center section-heading svg-sm colored">
                ...
                <p><b>Ещё кое-что: совсем скоро после свадьбы мы уезжаем, и было бы жалко, если бы подаренные живые цветы просто пропали, поэтому мы будем рады, если Вы предпочтете что-либо другое живым цветам 🙂</b></p>
