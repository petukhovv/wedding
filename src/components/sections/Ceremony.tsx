...
export class Ceremony extends Component<{}> {
    ...
    activities: Activities = {
        [ActivityType.FIRST_DAY]: {
            ...
            finishTime: "23:00",
            description: `
                В этот день в 14:00 комфортабельный автобус начнет свой маршрут на юге города и,
                направляясь к северу, соберет наших долгожданных гостей. С маршрутом автобуса и
                временем остановок вы можете ознакомиться, кликнув на "Детали" ниже. В 16:30 вас
                будет ждать приятный welcome-фуршет, во время которого вы сможете познакомиться
